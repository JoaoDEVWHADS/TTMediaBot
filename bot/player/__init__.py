...
class Player:
    ...
    def _play(self, arg: str, save_to_recents: bool = True) -> None:
        ...
        # Sleep for 4.0 seconds as required by YouTube's rate limiting/signature check delay
        # to prevent HTTP 403 Forbidden errors when loading media segments.
        logging.info("[Player] Sleeping 4.0 seconds to comply with YouTube signature delay...")
        time.sleep(4.0)
