...
- **🕵️ Progreso en Tiempo Real por Mensaje Privado (PV):** Mantente al tanto de tus descargas sin saturar el chat del canal.
...
| **bc** | `[+/-cmd]` | Bloquea/Desbloqueia un comando. |
| **l** | | Bloquea/Desbloqueia el bot (solo admins pueden usarlo). |
...
#### 6. Activar/Desactivar Atualizações Automáticas
...
**Síntomas:** El contenedor de Docker se apaga inmediatamente tras arrancar.
...
2. **Verifica la configuración:**
   ...
   - Comprueba si hay errores de sintaxe.
...
**Síntomas:** El bot no puede leer o escribir archivos.
...
- Logs del bot: `docker logs [nombre_bot]` o `bots/[nombre_bot]/TTMediaBot.log`.
